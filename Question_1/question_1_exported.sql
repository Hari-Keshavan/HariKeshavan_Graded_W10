...
--
-- Dumping routines for database 'graded'
--
...
BEGIN
    ...
    from supplier s left join supplier_pricing sp on s.supp_id = sp.supp_id left join order1 o on sp.pricing_id = o.pricing_id left join rating r on o.ord_id = r.ord_id group by s.supp_id, s.supp_name;
END ;;
DELIMITER ;
...
-- Dump completed on 2024-01-21 20:37:59
